...
class UserAPITests(APITestCase):
    ...
    def test_create_user(self):
        ...
        url = reverse('user:user-list')  # Ensure this URL matches your URL patterns
    ...
    def test_create_token_bad_credentials(self):
        ...
        res = self.client.post(token_url, {'username': 'wrong', 'password': 'wrong'})

        logger.debug(f"Bad credentials Response: {res.data}")
